...
public class WebDriverFactory {
	...
	public static WebDriver openBrowser(String nameOfBrowser, String url)
	{
		if ("".equals(nameOfBrowser)) {
			nameOfBrowser = ConfigReader.getConfiguration(
					SelConfig.BROWSER, 
					SelConfig.DEFAULT_BROWSER);
		}
		if ("".equals(url)) {
